...
#     ##check the 3D or 2D
#     if (len(np.shape(var_to_plot_dom1))) == 3:
#         var_to_plot_dom1=var_to_plot_dom1[0]
#         var_to_plot_dom2=var_to_plot_dom2[0]
#         var_to_plot_dom3=var_to_plot_dom3[0]
...
#     label=var_to_plot)
#     plt.savefig('test_'+str(time_step)+'.png')
files_for_anim=[]


output_dir='/Users/lmatak/Downloads/all/WRF_CHEM_CONTOURING/'
for file in natsorted(glob.glob(output_dir+'o3*')):
    print(file)
    files_for_anim.append((imageio.imread(file)))
imageio.mimsave(output_dir+'movie.gif', files_for_anim,duration=0.2)
