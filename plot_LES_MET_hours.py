...
sim_file='/Users/lmatak/Downloads/test_domain/Hourly_LES_SMAG3D_NO_SMOOTH_4.csv'
...
axes[0].plot(temperature_list.mean(axis=0)[:len(dom_avg_sim_temp)-5],label='obs data',color='black')
...
axes[1].plot(winds_list.mean(axis=0)[:len(dom_avg_sim_temp)-5],label='obs data',color='black')
...
axes[0].plot(sim_temp[5:],label='stations avg',color='green')
# # axes[1,1].plot(sim_pm_25,label='stations avg',color='green')
# # axes[2,0].plot(sim_o3,label='stations avg',color='green')
axes[1].plot(sim_wspd[5:],label='stations avg',color='green')
...
axes[0].plot(dom_avg_sim_temp[5:],label='domain avg',color='red')
# # axes[1,1].plot(dom_avg_sim_pm_25,label='domain avg',color='red')
# # axes[2,0].plot(dom_avg_sim_o3,label='domain avg',color='red')
axes[1].plot(dom_avg_sim_wspd[5:],label='domain avg',color='red')
