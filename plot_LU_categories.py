...
data_no_urb = xr.open_dataset('/Users/lmatak/Downloads/chem_outputs_test_contor/No_Urban/wrfout_d02_2019-08-02_11')
data_urb=xr.open_dataset('/Users/lmatak/Downloads/chem_outputs_test_contor/BEM/wrfout_d02_2019-08-02_11')
...
mask_BEM  = np.where(land_use_slice_no_urb == 13, np.nan, land_use_slice_no_urb)
mask_no_urb= np.where(land_use_slice_BEM != 13, np.nan, land_use_slice_BEM)
# Plot the land use categories
plt.subplot(1, 3, 1)
