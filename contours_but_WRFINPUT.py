...
dirs=['BEM','No_Urban'] #,'BEM_ust_10_in_LSM',]#'clz_1000','clz_100']
...
names=['BTXE','BTXS','BTYE','BTYS','BXE','BXS','BYE','BYS']
variables=['PH','DFI_QNDROP','QCLOUD','QGRAUP','QICE','QNDROP','QNGRAUPEL','QNICE','QNRAIN','QNSNOW','QRAIN','QSNOW','QVAPOR','T','U', \
           'V','W']
# variables=['HT_SHAD','MU','PC']
...
# for dir in dirs:
ZNT=[]
Input_Dir1 = '/Users/lmatak/Downloads/chem_outputs_test_contor/'+dirs[0]
Input_Dir2 = '/Users/lmatak/Downloads/chem_outputs_test_contor/'+dirs[1]
# Input_Dir = '/Users/lmatak/Downloads/URBAN_SCHEME_CONTOURING/different_times/'+dir
os.chdir(Input_Dir1)
ncfiles1=[]
ncfiles1 = sorted(os.listdir(Input_Dir1))
print('the directory is: ',Input_Dir1)
print('the ncfiles1 is: ',ncfiles1)
os.chdir(Input_Dir2)
ncfiles2=[]
ncfiles2 = sorted(os.listdir(Input_Dir2))
print('the directory is: ',Input_Dir2)
print('the ncfiles2 is: ',ncfiles2)

# print(sorted(ncfiles))
idx=0

fh1 = Dataset(ncfiles1[file_in_dir],mode='r')
print('fh 1',fh1)
fh2 = Dataset(ncfiles2[file_in_dir],mode='r')
print('fh 2',fh2)
        ...
        for i in range (0,12):
            for j in range (0,4):
                ...
                if dir != 'Jun_wrfoutputs':
                    ...
                    from_file_1 = fh1.variables[variabl+'_'+name][i][j][:]
                    from_file_2 = fh2.variables[variabl+'_'+name][i][j][:]
                    ...
                    # lst2=lats
                    #E_PM_10
                # print(variabl+'_'+name)
                if (from_file_1-from_file_2).max() > 0:
                    print((from_file_1-from_file_2).max())
...
# print('DIfference is : ',diff_in_temp.max())
